package com.hms.mohamedseliem.blubberoid;
...
import com.hms.mohamedseliem.blubberoid.adapters.ChatAdapter;
import com.hms.mohamedseliem.blubberoid.adt.ChatMessage;
import com.hms.mohamedseliem.blubberoid.servers.XirSysRequest;
import com.hms.mohamedseliem.blubberoid.util.Constants;
import com.hms.mohamedseliem.blubberoid.util.LogRTCListener;
import com.hms.mohamedseliem.blubberoid.WebRTC.api.Peer;
import com.hms.mohamedseliem.blubberoid.WebRTC.api.RTCClient;
import com.hms.mohamedseliem.blubberoid.WebRTC.api.SignalingParams;
...
public class VideoChatActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.RTCClient = new RTCClient(Constants.PUB_KEY, Constants.SUB_KEY, this.username);
        List<PeerConnection.IceServer> servers = getXirSysIceServers();
        if (!servers.isEmpty()){
            this.RTCClient.setSignalParams(new SignalingParams());
        }
        ...
        this.RTCClient.attachRTCListener(new DemoRTCListener());

        // Then attach your local media stream to the PnRTCClient.
        //  This will trigger the onLocalStream callback.
        this.RTCClient.attachLocalMediaStream(mediaStream);

        // Listen on a channel. This is your "phone number," also set the max chat users.
        this.RTCClient.listenOn(extras.getString(Constants.USER_NAME, ""));
        this.RTCClient.setMaxConnections(1);
    ...
    public void connectToUser(String user, boolean dialed) {
        this.RTCClient.connect(user, dialed);
    }

    public void hangup(View view) {
        this.RTCClient.closeAllConnections();
        endCall();
    }
    ...
    public void sendMessage(View view) {
        ...
        try {
            ...
            this.RTCClient.transmitAll(messageJSON);
    ...
    private class DemoRTCListener extends LogRTCListener {
        ...
        @Override
        public void onAddRemoteStream(final MediaStream remoteStream, final Peer peer) {
