...
public class SignalingParams {
    ...
    public SignalingParams(
            ...
            MediaConstraints videoConstraints,
            MediaConstraints audioConstraints) {
        this.iceServers       = SignalingParams.defaultIceServers();
        this.pcConstraints    = (pcConstraints==null)    ? defaultPcConstraints()    : pcConstraints;
        this.videoConstraints = (videoConstraints==null) ? defaultVideoConstraints() : videoConstraints;
        this.audioConstraints = (audioConstraints==null) ? defaultAudioConstraints() : audioConstraints;
    }
     ...
     * @param iceServers
     */
    public SignalingParams(List<PeerConnection.IceServer> iceServers) {
...
//        addIceServers(iceServers);
    ...
    public static SignalingParams defaultInstance() {
        MediaConstraints pcConstraints    = SignalingParams.defaultPcConstraints();
        MediaConstraints videoConstraints = SignalingParams.defaultVideoConstraints();
        MediaConstraints audioConstraints = SignalingParams.defaultAudioConstraints();
        List<PeerConnection.IceServer> iceServers = SignalingParams.defaultIceServers();
        return new SignalingParams(iceServers, pcConstraints, videoConstraints, audioConstraints);
    }
